...
import { Container,TabHeading, Header, Title, Content, Badge, Tab, Tabs, ScrollableTab, Text, Footer, FooterTab, Button, Icon, View, list, listItem, Body } from 'native-base';
